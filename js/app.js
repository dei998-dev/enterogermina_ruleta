...
const QS = [
  ...
  { id:2, text:"¿CUÁL ES EL DIFERENCIAL DE LAS 4 PRESENTACIONES DE ENTEROGERMINA?",         
    answers:[
      ...
      "La concentración de Bacillus clausii frente a la severidad del malestar intestinal.<br> Enterogermina presenta: Infant para el cólico del lactante - 2 Billones para síntomas leves - 4 Billones para síntomas moderados - 6 Billones para  síntomas severos."
    ],               
    correct:2, exp:"La concentración de Bacillus clausii frente a la severidad del malestar intestinal. Enterogermina presenta: Infant para el cólico del lactante - 2 Billones para síntomas leves - 4 Billones para síntomas moderados - 6 Billones para  síntomas severos." },
