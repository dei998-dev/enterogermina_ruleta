...
const QS = [
  ...
  { id:2, text:"¿CUÁL ES EL DIFERENCIAL DE LAS 4 PRESENTACIONES DE ENTEROGERMINA?",         
    answers:[
      ...
      "La concentración de Bacillus clausii frente a la severidad del malestar intestinal.<br> Enterogermina presenta: <br> Infant: cólico del lactante - 2 Billones: Síntomas leves - 4 Billones: Síntomas moderados - 6 Billones: Síntomas severos."
    ],               
